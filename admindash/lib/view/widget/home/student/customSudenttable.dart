...
import 'package:admindash/data/test/StudentList.dart';
            ...
            children: [
              TableRow(
                children: [
                  ...
                  tableCell(celValue(content: 'الرقم'.tr, isHeader: true)),
                  tableCell(celValue(content: 'الدورة'.tr, isHeader: true)),
              ...
              for (int index = 0; index < controller.students.length; index++)
                TableRow(
                  children: [
                    tableCell(
                      celValue(
                        content: controller.students[index].firstName,
                        isHeader: false,
                      ),
                    ),
                    tableCell(celValue(
                        content: controller.students[index].lastName,
                        isHeader: false)),
                    tableCell(
                      celValue(
                        content:
                            controller.students[index].dateCreate.toString(),
                        isHeader: false,
                      ),
                    ),
                    tableCell(
                      celValue(
                        content: controller.students[index].number,
                        isHeader: false,
                      ),
                    ),
                    tableCell(
                      celValue(
                        content: controller.students[index].level.toString(),
                        isHeader: false,
                      ),
                    ),
                    tableCell(
                      Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              Get.to(
                                  () => StudentPrile(student: students[index]));
                            },
