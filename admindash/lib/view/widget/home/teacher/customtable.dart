        ...
        return Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (int index = 0; index < controller.teachers.length; index++)
                TableRow(
                  children: [
                    tableCell(
                      celValue(
                        content: controller.teachers[index].firstName,
                        isHeader: false,
                      ),
                    ),
                    tableCell(celValue(
                        content: controller.teachers[index].lastName,
                        isHeader: false)),
                    tableCell(
                      celValue(
                        content:
                            controller.teachers[index].dateOfEntry.toString(),
                        isHeader: false,
                      ),
                    ),
                    tableCell(
                      celValue(
                        content: controller.teachers[index].module,
                        isHeader: false,
                      ),
                    ),
                    tableCell(
                      celValue(
                        content: controller.teachers[index].numberOfGroups
                            .toString(),
                        isHeader: false,
                      ),
                    ),
