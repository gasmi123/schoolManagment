...
import 'package:admindash/view/screen/Home/allCourses/AddTeacherToCourse.dart';

import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ListTeacherForCourse extends StatelessWidget {
  const ListTeacherForCourse({
    super.key,
  });
  @override
                    ...
                    children: [
                      TableRow(
                        children: [
                          ...
                          tableCell(celValue(
                              content: 'Teacher code'.tr, isHeader: true)),
                          tableCell(
